...
// GPS에 관한 모든 처리를 진행하고 얻어온 위도,경도 정보를 MainActivity로 전달
...
public class GpsSettingActivity extends AppCompatActivity {
    ...
    public static final int DEFAULT_LOCATION_REQUEST_PRIORITY = LocationRequest.PRIORITY_BALANCED_POWER_ACCURACY; // 스마트폰 전력을 효율적으로 사용하면서 위치 정보 얻기
    // GPS가 켜져있는 동안에 스마트폰을 들고 이동하게 된다면 바뀌는 위치 정보를 10초 ~ 20초사이마다 한번씩 콜백을 통해 새로운 위치 정보를 받겠다
   ...
   @Override
        ...
        settingsClient.checkLocationSettings(builder.build())
                .addOnSuccessListener(this, new OnSuccessListener<LocationSettingsResponse>() {
                    ...
                    public void onSuccess(LocationSettingsResponse locationSettingsResponse) { // OK일 때
                        ...
                        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(GpsSettingActivity.this);
                        fusedLocationProviderClient.requestLocationUpdates(locationRequest, locationCallback, null);
                    }
                })
                .addOnFailureListener(GpsSettingActivity.this, new OnFailureListener() {
                    @Override
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED: // 우리가 설정을 통해서 문제 해결이 가능한 경우
                                try {
                                    ...
                                    rae.startResolutionForResult(GpsSettingActivity.this, GPS_UTIL_LOCATION_RESOLUTION_REQUEST_CODE);
    ...
    private LocationCallback locationCallback = new LocationCallback() {
        ...
        public void onLocationResult(LocationResult locationResult) {
            ...
            // 위도, 경도 값을 들고 MainActivity로 이동
            Intent intent = new Intent(GpsSettingActivity.this, MainActivity.class);
